...
async def test_mcp_connection():
    ...
    try:
        ...
        logger.info(f"Available Twitter tools: {[name for name in tools.keys() if 'tweet' in name]}")
...
async def test_twitter_posting():
    ...
    # Test message
    test_message = "🤖 Testing automated tweet posting from AI agent - " + str(int(time.time()))
